...
achieving an overall \textbf{BLEU score of 56.2} on a curated 90-sentence parallel
...
Our higher BLEU (56.2) compared to reported NLLB-600M figures (30.5 on FLORES-200)
...
The gap between 0.15 and NLLB-200's published FLORES-200 score of 30.5 reflects
...
\begin{enumerate}
  \item \textbf{Open-domain BLEU vs. in-domain gap}: The 56.2 BLEU on the curated
        corpus contrasts with a 0.15 baseline BLEU on the Samanantar open-domain
        test set, highlighting sensitivity to corpus domain alignment. Both figures
        are internally consistent with published NLLB-200 behavior; the gap reflects
        SacreBLEU tokenization of Bengali script rather than a true model failure.
